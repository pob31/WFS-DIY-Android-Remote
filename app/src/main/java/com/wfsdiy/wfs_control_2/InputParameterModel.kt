...
object InputParameterDefinitions {
    ...
    val allParameters: List<InputParameterDefinition> = listOf(
        ...
        InputParameterDefinition(
            group = "Input",
            label = "Offset Z",
            variableName = "offsetZ",
            oscPath = "/remoteInput/offsetZ",
            isIncoming = true,
            isOutgoing = true,
            uiType = UIComponentType.NUMBER_BOX,
            dataType = ParameterType.FLOAT,
        ...
        InputParameterDefinition(
            ...
            variableName = "coordinateMode",
            oscPath = "/remoteInput/coordinateMode",
            isIncoming = true,
            isOutgoing = false,  // Read-only from server
        ...
        InputParameterDefinition(
            group = "Input",
            label = "Constraint Distance Min",
            variableName = "constraintDistanceMin",
            oscPath = "/remoteInput/constraintDistanceMin",
            isIncoming = true,
            isOutgoing = true,
            uiType = UIComponentType.NUMBER_BOX,
            dataType = ParameterType.FLOAT,
        ...
        InputParameterDefinition(
            group = "Input",
            label = "Constraint Distance Max",
            variableName = "constraintDistanceMax",
            oscPath = "/remoteInput/constraintDistanceMax",
            isIncoming = true,
            isOutgoing = true,
            uiType = UIComponentType.NUMBER_BOX,
            dataType = ParameterType.FLOAT,
